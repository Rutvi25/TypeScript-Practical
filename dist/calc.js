    ...
    button.addEventListener("click", (e) => {
        ...
        switch (target.innerText) {
            ...
            case "n!":
                ...
                else if (parseFloat(calcScreen.value) == 0)
                    calcScreen.value = "1";
                else
            ...
            case "1/𝑥":
                if (parseFloat(calcScreen.value) == 0)
                    ...
                    calcScreen.value = String(1 / parseFloat(calcScreen.value));
                break;
            // Root
            case "√𝑥":
            ...
            // Power
            case "10𝑥":
                calcScreen.value = String(Math.pow(10, parseFloat(calcScreen.value)));
                break;
            case "2𝑥":
                calcScreen.value = String(Math.pow(2, parseFloat(calcScreen.value)));
                break;
            case "e𝑥":
                calcScreen.value = String(Math.pow(Math.E, parseFloat(calcScreen.value)));
                break;
            case "𝑥3":
                calcScreen.value = String(Math.pow(parseFloat(calcScreen.value), 3));
                break;
            case "𝑥2":
                calcScreen.value = String(Math.pow(parseFloat(calcScreen.value), 2));
                break;
